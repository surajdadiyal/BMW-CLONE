...
function ElectricLargeLayout() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center bg-neutral-950">
            ...
            <div className="w-11/12 flex flex-col items-center justify-center absolute top-1/4 left-0">
                <div
                    data-aos="fade-right"
                    data-aos-duration="3000"
                    className="w-4/5 flex flex-col items-start justify-center space-y-7">
                    <h2 className="text-6xl text-white font-medium">BMW ELECTRIC CARS</h2>
                    <h4 className="text-2xl text-white font-normal">EXCLUSIVE FESTIVE EMI STARTING AT ₹59,999/MONTH*</h4>
            ...
            <div className="w-11/12 flex flex-col items-center justify-center mt-10 py-5">
                <div className="flex items-center justify-center">
                    <div
                        data-aos="zoom-out"
                        data-aos-duration="3000"
                        className="flex items-start justify-center flex-col space-y-5">
                        <h1 className="text-5xl font-medium text-white">THE BMW ELECTRIC CARS.</h1>
                        <h4 className="text-xl font-medium text-white/65">100 % electric. 100 % driving pleasure. 100 % BMW.</h4>
                ...
                <div className="w-full flex flex-col items-start justify-center my-10">
                    ...
                    <div
                        data-aos="zoom-in"
                        data-aos-duration="3000"
                        className="w-full flex items-center justify-start my-10">
                ...
                <div
                    data-aos="zoom-out"
                    data-aos-duration="3000"
                    className="w-full flex flex-col items-start justify-center my-10">
                    <div
                    ...
                    {data.map((repetition, index) => {
                        ...
                        return render && (
                            <div
                                className={`${event} w-full flex items-center justify-center my-10`}
                                key={index}
                            >
                                <div
                                    data-aos="zoom-in"
                                ...
                                <div
                                    data-aos="zoom-out"
                                    data-aos-duration="3000"
                                    className="w-1/2 flex flex-col p-4 space-y-5">
                                    <ShinyText
                                        className="text-4xl"
                                        text={heading}
                                        disabled={false}
                                        speed={3}
                                    />
                                    <p className="text-base text-white/65 font-normal text-justify text-wrap">{hide && content}</p>
                                    <ul>
                                        {show &&
                                            content.map((arr, index) => {
                                                return (
                                                    <li
                                                        key={index}
                                                        className="list-disc text-white/65">{arr}
                                                    </li>
                                                )
                                            })}
                                    </ul>
                ...
                <div className="w-full flex flex-col items-center justify-center space-y-5 my-5">
                    <div
                        ...
                        <h2 className="text-4xl text-white font-medium">FAQ: THE MOST IMPORTANT QUESTIONS AND ANSWERS ON BMW ELECTRIC CARS.</h2>
                    </div>
                    {data.map(({ img, heading, list, type }, index) => {
                        ...
                        return category && (
                            <div
                                ...
                                <Accordions
                                    heading={heading}
                                    className={'text-white/65 font-bold text-xl'}
                                    img={img}
                ...
                <div className="w-full flex flex-col items-center justify-center space-y-5 my-5">
                    <div
                        ...
                        data-aos-duration="3000"
                        className="w-full flex items-center justify-start">
                        <h2 className="text-4xl text-white font-medium">FAQ: QUESTIONS & ANSWERS ABOUT THE RANGE OF BMW ELECTRIC CARS.</h2>
                    </div>
                    {data.map(({ img, heading, list, type }, index) => {
                ...
                <div
                    ...
                    <div
                        data-aos="zoom-out"
                        data-aos-duration="3000"
                        className="w-11/12 flex flex-col items-start justify-center my-5">
...
export default ElectricLargeLayout