...
import ModelConfiguratorLayout from "../context/ModelConfiguratorLayout";
...
function Configurator() {
  ...
  const dialog = [
    { name: "SEDAN", id: 1, value: "Sedan" },
    { name: "Sports Activity Vehicle", id: 2, value: "Sports" },
    { name: "Coupé", id: 3, value: "Coupe" },
    { name: "i", id: 4, value: "i" },
    { name: "Gran Turismo", id: 5, value: "GT" },
    { name: "Gran Coupé", id: 6, value: "GranCoupe" },
    { name: "Roadster", id: 7, value: "Roadster" },
  ];
  ...
  const handleSeeResults = () => {
    ...
    navigate(`/configurator/filter?${queryParams.toString()}`);
  };
  ...
  const filteredModels = configuratorModel.filter((filterModel) => {
